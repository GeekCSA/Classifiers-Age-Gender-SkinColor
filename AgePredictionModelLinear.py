...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        for i in range(80001):
            ...
            if i % 200 == 0:
                ...
                print('Iteration:', i, ' loss_train:',
                      age_loss.eval(feed_dict={X_in: batch_train, X_age: details_train, keep_prob: 1.0}))
                print("\n\n\n")
                k_test += 1
        ...
        # Save the variable in the file
        saved_path = saver.save(sess, "Final_Age_prediction" + '/saved_variable')
        print('model saved in {}'.format(saved_path))